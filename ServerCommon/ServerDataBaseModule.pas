...
var
  ...
  AUniQuery:TUniQuery;
begin
  uBaseLog.HandleException(nil, 'TDatabaseModule.tmrActiveMySQLPoolConnectionTimer');
      ...
      begin
          ...
          begin
              ...
              try
                ...
                begin
                  //记录出错日志
                  uBaseLog.HandleException(E, 'TDatabaseModule.tmrActiveMySQLPoolConnectionTimer');
                end;
              end;
